...
% (regions created by CRO), but which are too close for their f0 to make sense,
...
%
% - the function SIMP calculates an approximative f0 value.
...
%%%%%%%%%%% Calculating f0 on the basis of the unique peaks
f0 = [];
