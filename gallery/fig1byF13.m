...
% plotting fo. Colour: light green [0.0196 0.9686 0.6118], later changed to deeper green [.0863 .7216 .3059] with darker edges [0.12 0.63 0.33]. 
...
% Axis for best legibility: up to 300 Hz, unlike 160 Hz for the male speakers.
axis([1 length(fo) 0 300])

            xlabel('green: f_0; orange: O_q from local max; blue: O_q from barycentre.')
            ylabel('f_0 in Hz; O_q in %')
print('-dpdf', 'C:\Dropbox\GitHub\egg\gallery\images\1_F13.pdf')
print('-dpng', 'C:\Dropbox\GitHub\egg\gallery\images\1_F13.png')
